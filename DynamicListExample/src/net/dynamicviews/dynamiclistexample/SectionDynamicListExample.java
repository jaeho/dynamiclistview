...
public class SectionDynamicListExample extends Activity {
	...
	public static SectionAdapter getSampleSectionAdapter(Context context) {
		...
		Collections.addAll(contentsKor, context.getResources().getStringArray(R.array.sample_kor));
		Collections.addAll(contentsEng, context.getResources().getStringArray(R.array.sample_eng));
		Collections.addAll(contentsNum, context.getResources().getStringArray(R.array.sample_num));
